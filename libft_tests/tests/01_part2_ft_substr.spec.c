...
{
	mt_assert(ft_substr(str, 0, (size_t)-10) == NULL);
}

static void test2(t_test *test)
{
	mt_assert(strcmp(ft_substr(str, 8, 8), "je serai") == 0);
}

static void test3(t_test *test)
{
	mt_assert(strcmp(ft_substr(str, 0, 0), "") == 0);
}

void	suite_01_part2_ft_substr(t_suite *suite)
{
